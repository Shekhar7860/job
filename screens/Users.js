...
const advert = firebase.admob().interstitial('ca-app-pub-2457999726327943/4370397800')
...
export default class Users extends Component {
 ...
 setTimeout(() => {
  ...
  render() {
    ...
    return (
      ...
      <View style={styles.container} >
       ...
       <TouchableOpacity onPress={() => this.goBack()}>
                    ...
                    <Image style={{width:30,marginRight:5,  height:30}}source={require('../images/plus.png')}></Image>
                    </TouchableOpacity>
                </View>
       {this.state.items !== [] ?
          <FlatList
        ...
        >
         ...
         <Text style={styles.email}>Profile : {item.profile}</Text>
    ...
    size={"LARGE_BANNER"}
  unitId={"ca-app-pub-2457999726327943/2975772696"}
